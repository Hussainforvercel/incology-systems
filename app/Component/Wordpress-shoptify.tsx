                    ...
                    {items && (
                        <ul className="space-y-4">
                            {items.map((item: any, idx: number) => (
                                <li
                                    key={idx}
                                    className="flex items-start gap-3 bg-[#0A0E14]/40 p-4 rounded-lg  "
                                >
...
/* ---------------- Main Section ---------------- */
export default function WordpressDevServices() {
    ...
    return (
        <section className="bg-[#04070D] relative">
            ...
            <MenuSplit
                ...
                image="/images/wordpressshop1.webp"
                items={[
                    {
                     
                        text: "Custom themes & plugins.",
                    },
                    {
                        text: "Membership portals, blogs, and corporate websites.",
                    },
                    {
                     
                        text: "Search-engine-friendly structures for better rankings.",
                    },
            ...
            <MenuSplit
                ...
                image="/images/wordpressshop2.jpg"
                items={[
                    {
                     
                        text: " Conversion-focused online stores.",
                    },
                    {
                        
                        text: "Payment gateways & shipping integration.",
                    }, 
                    {
                        
                        text: "Shopify apps for added functionality.",
                    },

                    {
                        
                        text: "Migration and performance optimization.",
                    },
                ]}
                extraText="Whether you need a CMS-driven website or an e-commerce powerhouse, we’ll tailor a solution that grows with your business."
            />
