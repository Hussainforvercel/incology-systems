...
/* ---------------- Main Section ---------------- */
export default function DigitalDevServices() {
    ...
    return (
        <section className="bg-[#04070D] relative">
            ...
            <MenuSplit
                title="Our Expertise:"
                image="/images/digitalmarketing1.jpg"
                items={[
                    {
                        title: "SEO (Search Engine Optimization):",
                        text: "Keyword research, technical optimization, and content strategies that improve your rankings.",
                    },
                    {
                        title: "Social Media Marketing: ",
                        text: "Paid and organic campaigns that build awareness and drive engagement.",
                    },
                    {
                        title: "Social Media Management:",
                        text: "Content planning, posting schedules, and analytics reporting to keep your audience engaged",
                    },
                ]}
            />
            ...
            <MenuSplit
                ...
                items={[
                    {
                        title: "Google Ads:",
                        text: "  Pay-per-click campaigns tailored for maximum ROI",
                    },
                    {
                        title: "Analytics & Insights:",
                        text: "Using Google Analytics, Search Console, and SEMrush, we track performance and fine-tune strategies",
                    },
                ]}
                extraText="We don’t just run campaigns—we craft sustainable growth systems that ensure long-term visibility and engagement."
            />
